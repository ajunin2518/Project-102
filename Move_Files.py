...
from_dir = "C:/Users/ajuni/Downloads/class104/PRO-104-Reference-Code-main"
to_dir = "C:/Users/ajuni/Downloads"
...
for file_name in list_of_files:
    ...
    if extension == '':
        continue
    if extension in [".exe , .msi,  .gif, .png .jpg, .jpeg, .csv, .pdf , .xls , .xlsx , .ppt , .pptx"]:
